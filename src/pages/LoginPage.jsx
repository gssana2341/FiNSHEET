...
export default function LoginPage({ onLogin, onGoToRegister, onGoToForgot }) {
  ...
  const validate = () => {
    if (!username.trim()) return t('auth.requiredField');
  ...
  const handleGoogleLogin = () => {
    ...
    setTimeout(() => {
      setIsLoading(false);
      onLogin({ username: 'google_user@gmail.com', provider: 'google' });
    }, 1500);
  };
      ...
      <div className="auth-container">
        ...
        <div className="auth-form-panel">
          ...
          <div className="auth-form-wrapper">
            ...
            {/* Google Sign In */}
            <button className="auth-google-btn" onClick={handleGoogleLogin} disabled={isLoading} id="google-login-btn">
            ...
            <form className="auth-form" onSubmit={handleSubmit}>
              ...
              <div className="auth-options">
                ...
                <button type="button" className="auth-forgot-link" onClick={onGoToForgot}>
              ...
              <button type="submit" className="auth-submit-btn" disabled={isLoading} id="login-submit">
                {isLoading ? (
